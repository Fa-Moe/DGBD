...
BC_report <- function(df_abundance=NULL,column=NULL,BC_plot_object=NULL,show_plot=TRUE,show_stats=TRUE,...){
  if(!is.null(BC_plot_object)){t_BCplot<- BC_plot_object}
  else if (!is.null(df_abundance)){t_BCplot<-BC_plot(df_abundance,column=column,...)}
